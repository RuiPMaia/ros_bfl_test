...
public:
    ...
    /*void MeasurementCb(ardrone_autonomy::Ranges msg)
    {
    ...
    /*void InputCb(ardrone_autonomy::Navdata msg)
    {
    ...
    void handleMapMessage(const nav_msgs::OccupancyGrid& msg)
    {
      ...
      ROS_INFO("Index x0=%f y0=%f", MAP_GXWX(map_,0.0), MAP_GYWY(map_,0.0));

      ROS_INFO ("Front range %f", map_calc_range(map_, 0.0, 0.0, 0.0, 15.0));
